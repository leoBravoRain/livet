                    ...
                    >
                        ...
                        >
                                    ...
                                    this.state.product.saleFormats.map((saleFormat,idx)=> {
                                        return (
                                            <FormControlLabel 
                                                value={idx} 
                                                control={<Radio />} 
                                                label={saleFormat.format + " - $ " + parseInt(saleFormat.price).toLocaleString("nl-NL") + (saleFormat.stock != 0 ? " (stock: " + saleFormat.stock + ")" : " (sin stock disponible)")} 
                                            />
                                        )
                                    })
                                }
                            ...
                            >
                                ...
                                Total: $ {(parseInt(this.state.product.saleFormats[this.state.formatIndex].price) * this.state.units).toLocaleString("nl-NL")}
                            </Typography>
